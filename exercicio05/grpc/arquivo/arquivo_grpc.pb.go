...
func NewArquivoServiceClient(cc grpc.ClientConnInterface) ArquivoServiceClient {
...
// ArquivoServiceServer is the server API for ArquivoService service.
...
// UnimplementedArquivoServiceServer must be embedded to have
...
// UnsafeArquivoServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to ArquivoServiceServer will
// result in compilation errors.
type UnsafeArquivoServiceServer interface {
	mustEmbedUnimplementedArquivoServiceServer()
}

func RegisterArquivoServiceServer(s grpc.ServiceRegistrar, srv ArquivoServiceServer) {
	// If the following call pancis, it indicates UnimplementedArquivoServiceServer was
...
// ArquivoService_ServiceDesc is the grpc.ServiceDesc for ArquivoService service.
